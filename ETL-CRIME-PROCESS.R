...
directory_path <- "G:/Abiodun/Path/DATA WAREHOUSE DATA/Crime_data/Data_Source"
...
Police_data <- read.csv("G:/Abiodun/Path/DATA WAREHOUSE DATA/Crime_data/Police_Force_Strength/Police_Force_Strength.csv", stringsAsFactors = FALSE)
